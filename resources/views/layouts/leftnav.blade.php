        ...
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                @if (Auth::user()->role_id == RoleEnum::COMPANY)
                    ...
                    <li class="">
                        <a href="{{route('inputs')}}"><img src="{{ asset('assets/img/icons/product.svg') }}" alt="img"><span class="text-success text-uppercase"> Entrées</span>
                            </a>
