        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div wire:key="{{$key+1}}" class="row mt-2">
                    ...
                    <div class="col-2"><span><button><i class="fa fa-minus"></i></button></span>
                        <input type="text" wire:model.differ="quantity" value="{{$item->quantity}}" class="p-1">
                        <span><button><i class="fa fa-plus"></i></button></span></div>
                    <div class="col-2"></div>
